...
<?php 
                    $no=0;
                    foreach ($tampil_edit->result_array() as $a):
                        $no++;
      ...
      <form class="form-horizontal" method="post" name="formS" action="<?php echo base_url().'index.php/Transaksi_penjualan_controller/update_transaksi_penjualan'?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <input class="form-control" type="text" name="tanggal" id="" value="<?php echo $tanggal?>" placholder/>
                      <input class="form-control" type="hidden" name="kode_transaksi" id="" value="<?php echo $kode_transaksi?>" placholder/>
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <table>
                        <tr>
                          <td width="1000">
                      <input class="form-control" type="text" name="kode_obat" id="kode_obat" value="<?php echo $kode_obat?>" readonly placholder/>
                          </td>
                          <td>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nama_obat"id="nama_obat"  class="form-control" cols="30" value="<?php echo $nama_obat?>"rows="3"></input>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <input name="harga_jual" id="harga" onFocus="startCalc();"  value="<?php echo $harga_jual?>"onBlur="stopCalc();" onBlur="stopCalc();"style="width:335px;" class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="stok"    onFocus="startCalc();"  onBlur="stopCalc();" value="<?php echo $stok?>" style="width:335px;"class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="total" onkeyup="convertToRupiah(this);" id="total" style="width:335px;"value="<?php echo $total?>" class="form-control" type="text" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="bayar"   id="bayar" onFocus="startCalc();"value="<?php echo $bayar?>"  onBlur="stopCalc();" style="width:335px;"class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="kembalian" onkeyup="convertToRupiah(this);" value="<?php echo $kembalian?>"id="kembalian" style="width:335px;" class="form-control" type="text" required >
