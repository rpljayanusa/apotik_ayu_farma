...
?>-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    <strong>Transaksi Berhasil Silahkan Cetak Faktur !</strong>
                    <a class="btn btn-default" href="<?php echo base_url().'index.php/Transaksi_penjualan_controller/'?>"><span class="fa fa-backward"></span>Kembali</a>
                    ...
                    <input type="hidden"  value="<?php echo $a['kode_transaksi'];?>" name="">
                <?php }?>
                    <a class="btn btn-info" href="<?php echo base_url().'index.php/Transaksi_penjualan_controller/faktur/'.$a['kode_transaksi'];?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by m lamepal wanda</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
