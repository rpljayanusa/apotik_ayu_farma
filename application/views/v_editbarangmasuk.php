...
<?php
                    ...
                    ?>
      <form class="form-horizontal" method="post" name="formS" action="<?php echo base_url().'index.php/Barangmasuk_controller/update_barangmasuk'?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input class="form-control" type="hidden" name="kode_obat" id="" value="<?php echo $kode_obat?>" placholder/>
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <table>
                        <tr>
                          <td width="1000">
                      <input class="form-control" type="text" name="suplier" id="nama_suplier"value="<?php echo $suplier?>" placholder/>
                          </td>
                          <td>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="satuan" value="<?php echo $satuan?>" class="form-control" cols="30" rows="3"></input>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="jumlah" value="<?php echo $jumlah?>"  id="jumlah" onFocus="startCalc();"  onBlur="stopCalc();" style="width:335px;"class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <input name="harga" value="<?php echo $harga?>" id="harga" onFocus="startCalc();" onBlur="stopCalc();" onBlur="stopCalc();"style="width:335px;" class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="total"value="<?php echo $total?>" onkeyup="convertToRupiah(this);" id="total" style="width:335px;" class="form-control" type="text" required >
...
glyphicon-floppy-saved"></span> Update</button> 
            <a href="<?php echo base_url().'index.php/Barangmasuk_controller'?>" class="btn btn-default float-right">Cancel</a>
          </div>
          <!-- /.card-footer -->
          </form>
        </div>
